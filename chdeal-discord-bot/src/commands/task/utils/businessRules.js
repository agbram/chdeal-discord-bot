// src/commands/task/utils/businessRules.js
import pipefyService from '../../../services/pipefyService.js';
import { logger } from '../../../utils/logger.js';
import { MAX_TASKS_PER_USER } from '../constants.js';

/**
 * Valida campos obrigatórios de um card
...
/**
 * Verifica limite de tasks por usuário
 * @param {string} userId - ID do Discord
...
/**
 * Registra alteração de uma task
 * @param {string} cardId - ID do card
